...
def eval_ood_md2sonn(opt, config):
    ...
    #integration of get_network_output function with predictions, labels and cloud points
    ...
    eval_ood_sncore(
        ...
        points_list=[src_points, tar1_points, tar2_points],  # passing also pointclouds
        src_label=1, Ancase=2)
    print("#" * 80)
